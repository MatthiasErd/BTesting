...
DATA_PATH = "/home/maedd/Documents/Bachelorarbeit/Network/Files/dataEssentiaStandard.json"
SAVED_MODEL_PATH = "/home/maedd/Documents/Bachelorarbeit/Network/Files/EssentiaStandard.h5"
protobuf_file = "/home/maedd/Documents/Bachelorarbeit/Network/Protobufs/EssentiaStandard.pb"
...
def load_dataset(data_path):
    ...
    #X = X[0, :, :]
    print("[MFCCS] ", " Dimension: ", X.ndim, " length: ", len(X))
    print("[labels] ", " Dimension: ", y.ndim, " length: ", len(y))
...
def get_data_splits(data_path, test_size=0.1, test_validation=0.1):
    ...
    print("before conversion from 2d to 3d arrays: ")
    ...
    print("after conversion from 2d to 3d arrays: ")
    print("X_train.ndim: ", X_train.ndim)
...
def main():
    ...
    #tf.train.write_graph(frozen_graph, './Protobufs/', 'Librosa.pbtxt', as_text=True)
    #tf.train.write_graph(frozen_graph, './Protobufs/', protobuf_file, as_text=False)
